...
class MessageTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Table striped bordered hover className="text-start w-100 border-green">
                    <thead>
                        <tr className="text-green border-green">
                            <th>ID</th>
                            <th>Name</th>
                ...
                <div className="w-100 text-end">
                    <Button variant={"outline-light text-green border-green me-2"}
                        onClick={this.prevPage.bind(this)}>
                        &lt;
                    </Button>
                    <Button variant={"outline-dark text-green border-green"}
