    ...
    render() {
        ...
        for(let item in this.props.msgDetails){
            if(isNaN(item)){
                ...
                listContent.push(
                    <tr key={cnt}
                        className="text-green text-start">
        ...
        return (
            <div>
                <Table striped bordered hover className="text-left w-100 border-green">
                    <thead>
                        <tr>
                            <th colSpan="2"
                ...
                <div className="w-100 text-center">
                    <Button variant={"outline-dark rounded-pill text-green border-green me-2"}
                        className="float-left"
                        onClick={this.delete.bind(this)}>
                        Delete
                    </Button>
                    <Button variant={"outline-dark rounded-pill text-green border-green"}
