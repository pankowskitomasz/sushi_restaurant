...
class Dashboard extends Component{
    ...
    render(){
        return(        
            <Container fluid className={"login-form bg-dark align-items-start p-0 py-5 d-flex minh-footer-adj "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 mt-5">
                    ...
                    <Col xs={12} md={9} className="mx-auto p-0 d-flex align-items-start p-3">
                        <Card className="w-100 minh-50vh bg-form border-green">
                            <Card.Body>
                                <p className="initialism text-green text-start border-bottom border-green mb-4">
                                    Dashboard
                                </p>
                            </Card.Body>
                        </Card>
